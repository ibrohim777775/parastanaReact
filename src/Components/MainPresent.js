...
import BgFor from '../images/header_bg.svg'
      ...
      <StyledMain>
        <div className='main__bg'>
          <div className='main__bg-items'>
            ...
            <p className='main__bg-text'>Получите 500 рублей за подписку на рассылку</p>
            <Button width='217px' height='52px' fontSize='25px' text='Подписаться'></Button>
          </div>
